                ...
                >
                    ...
                    >
                        <div className='text-center'>
                            ...
                            <h3 className='text-2xl font-bold text-[#405e7f] mb-2'>Ya estás postulado</h3>
                            <p className='text-gray-600 mb-6'>Tu hoja de vida ya está postulada a esta vacante, no necesitas postularte denuevo.</p>
                            <Button
                                btnName='Cerrar'
                                clicked={onClose}
