...
export const ConfirmAlert = ({ message, onConfirm, onCancel }) => {
  return (
    <div className='fixed inset-0 bg-black/40 flex items-center justify-center z-50'>
      <div className='modal-auth general rounded-xl p-6 w-full max-w-md'>
        <h3 className='modal-auth-title text-xl font-semibold mb-4 text-center text-[color:var(--color-card-text)]'>{message}</h3>
